...
<html lang="en">
    <head>
        ...
        <link href="{{ asset("adminAssets")}}/assets/css/styles.css" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        ...
        <script src="{{ asset("adminAssets")}}/assets/js/datatables-simple-demo.js"></script>
    </body>
</html>
